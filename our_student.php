...
<div id="bodychild">
	<div id="outercontainer">
        ...
        <div id="outermain">
        	<div id="maincontent">
        	<section id="mainthecontent"> <h2><font color="#000000"><b>Our Students</b></font></h2>
		  ...
		  <td><b><font color="#FFFFFF">Sr. No.</font></b></td>
		   <td><font color="#FFFFFF"><b>Student ID</b></font></td>
		   <td><font color="#FFFFFF"><b>Student Name</b></font></td>
		    <td><font color="#FFFFFF"><b>Father's Name</b></font></td>
			 <td><font color="#FFFFFF"><b>Course Enrolled</b></font></td>
		  </tr>
          <?php include_once("umaadmin/db.php") ?>
          <?php $val = mysql_query("select * from registration"); ?>
          <?php $a = 1; ?>
          <?php while($res = mysql_fetch_object($val)) { ?>
		  <tr align="center" bgcolor="#FFFFFF">
		  <td><font color="#0033FF"><?php echo $a; ?></font></td>
		  <td><font color="#0033FF"><?php echo $res->stu_id; ?></font></td>
		  <td><font color="#0033FF"><?php echo $res->name; ?></font></td>
		  <td><font color="#0033FF"><?php echo $res->fname; ?></font></td>
		  <td><font color="#0033FF"><?php echo $res->course; ?></font></td>
		  </tr>
          <?php $a++; ?>
          <?php } ?>
          </tbody>
